    ...
    <div id="main-content">
        <div class="top-menu px-3 d-flex justify-content-end">
            ...
            <div class="logout-div d-flex align-item-center">
                <p class="rounded-5 m-0 px-4 py-2"> TEST </p>
                <a href="" class="rounded-5 icon px-2 pe-3 py-2">
        ...
        <footer class="top-menu px-3 d-flex justify-content-between">
            <div class="copyright">
                <p class="m-0"> Copyright © 2024 <a href="https://byteminds.sk" target="_blank" rel="noopener noreferrer">Byteminds.sk</a>. Všetky práva vyhradené.</p>
            </div>
        </footer>
    </div>
</div>
